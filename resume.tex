...
\begin{document}
    ...
    \begin{rSection}{Work Experience}
        \textbf{Applied AI Engineer} \hfill Feb 2026 --- Present \\
        Tario AI \hfill \textit{Bengaluru, India}
        \begin{itemize}
            \item Building an agentic SDR system with LangChain to automate lead research, enrichment, and outreach, cutting manual SDR prep from hours to minutes per lead.
            \item Designed a weighted round robin mailbox rotation system that enforced daily per mailbox send caps, cutting spam related sending blocks as outbound volume scaled.
            \item Designed a FastAPI based custom agent runtime that gives agents full tool access, letting users ship trigger-based automations in minutes instead of custom engineering cycles.
            \item Built a dialer voice assistant with 900ms end-to-end latency for real time replies, grounded in personalized research from LinkedIn scrapers and web research agents.
            \item Built an internal code dependency graph across all microservices and exposed it over MCP to accelerate the developer workflow.
        \end{itemize}
    ...
    \begin{rSection}{Skills}
        \begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
            ...
            Backend & FastAPI, Node.js, Django, LangChain, LangGraph \\
            Frontend & React, Next.js \\
            Systems / Cloud & Docker, Amazon Web Services \\ \\
        \end{tabular}\\
    \end{rSection}
